    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card card-default">
                ...
                <!-- /.card-body -->
                <div class="card-footer">
                    <button type="submit" class="btn btn-info" data-toggle="modal" data-target="#edit-essay">Edit</button>
                    <button type="submit" class="btn btn-danger float-right">Delete</button>
                </div>
            </div>
            <!-- /.card -->
        ...
        <div class="col-md-6">
            <div class="card card-default">
                ...
                <!-- /.card-body -->
                <div class="card-footer">
                    <button type="submit" class="btn btn-info" data-toggle="modal" data-target="#edit-weighted-mc">Edit</button>
                    <button type="submit" class="btn btn-danger float-right">Delete</button>
                </div>
            </div>
            <!-- /.card -->

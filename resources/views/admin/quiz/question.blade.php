                            ...
                            <div id="optionsContainer" class="form-group">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <span class="input-group-text" style="background-color: red; cursor: pointer;"
                                            onclick="removeOption(this)"><i class="fas fa-trash"
                        ...
                        <table class="table table-head-fixed text-nowrap">
                            ...
                            <tbody>
                                <tr data-widget="expandable-table" aria-expanded="false">
                                    <td>183</td>
                                    <td>John Doe</td>
                                    <td><button type="button" class="btn-sm btn btn-info">Edit</button><button
                                            type="button" class="btn-sm btn btn-danger ml-1">Delete</button></td>
                                </tr>

            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr data-widget="expandable-table" aria-expanded="false">
                        ...
                        <td>{{ $user->role }}</td>
                        <td><button>Reveal Password</button></td>
                        <td>
                            <a class="btn btn-info btn-sm" href="/admin/user/edit/{{ $user->id }}">
                                Edit
                            </a>
                            <button type="button" class="btn btn-danger btn-sm delete-btn" data-id="{{ $user->id }}" data-toggle="modal" data-target="#delete">
                                Delete
                            </button>
                        </td>
                    </tr>
                    <tr class="expandable-body">
                        <td colspan="6"> <!-- Ensure colspan matches the number of columns in the table -->
                            <p>
                                Expandable content for user {{$user->id}} <!-- Replace this with actual expandable content if needed -->
                            </p>
                        </td>
                    </tr>
                    @endforeach
